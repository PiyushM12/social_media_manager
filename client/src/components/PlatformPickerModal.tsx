        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md border border-slate-100">
            ...
            {PLATFORMS.map((p)=>{
                ...
                return(
                    ...
                    className={`flex items-centergap-3 p-3.5 rounded-xl border text-left transition-all ${isConnected?"border-red-200 bg-red-50 cursor-default":"border-slate-200 bg-slate-50 hover:border-slate-300 hover:bg-slate-100 cursor-pointer"} ${isConnecting && "opacity-60"} `} >
                        <div className="p-2">
                        ...
                        {isConnecting && <div className="size-4 border-2  border-red-600
